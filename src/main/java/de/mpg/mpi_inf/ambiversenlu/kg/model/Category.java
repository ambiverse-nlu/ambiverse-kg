...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaJerseyServerCodegen", date = "2018-02-22T13:34:06.151Z")
public class Category   {
   ...
   **/
  @JsonProperty("id")
  @ApiModelProperty(example = "YAGO3:<wikicat_Billionaires>", required = true, value = "Knowledge graph ID of the category.")
  @NotNull
  @JsonInclude(JsonInclude.Include.NON_EMPTY)
  public String getId() {
    return id;
   ...
   **/
  @JsonProperty("name")
  @ApiModelProperty(example = "Billionaires", required = true, value = "Human-readable name of the category.")
  @NotNull
  @JsonInclude(JsonInclude.Include.NON_EMPTY)
