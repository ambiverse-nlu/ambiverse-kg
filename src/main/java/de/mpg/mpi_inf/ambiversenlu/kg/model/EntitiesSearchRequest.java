...
public class EntitiesSearchRequest   {
   ...
   **/
  @JsonProperty("latitude")
  @ApiModelProperty(example = "49.257792", required = true, value = "The latitude of a point of interest.")
  @NotNull
  @JsonInclude(JsonInclude.Include.NON_EMPTY)
   ...
   **/
  @JsonProperty("longitude")
  @ApiModelProperty(example = "7.046052", required = true, value = "The longitude of a point of interest.")
  @NotNull
  @JsonInclude(JsonInclude.Include.NON_EMPTY)
   ...
   **/
  @JsonProperty("distance")
  @ApiModelProperty(example = "2.0", required = true, value = "The distance to the point of interest.")
  @NotNull
  @JsonInclude(JsonInclude.Include.NON_EMPTY)
