 ...
 * Author
 */
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2019-10-24T12:54:00.720Z[GMT]")public class Author   {
  @JsonProperty("name")
   ...
   **/
  @JsonProperty("name")
  @Schema(example = "World Economic Forum", description = "The name of the image author.")
   ...
   **/
  @JsonProperty("url")
  @Schema(example = "http://en.wikipedia.org/wiki/User:World_Economic_Forum", description = "URL of the user page of the image author in Wikipedia.")
