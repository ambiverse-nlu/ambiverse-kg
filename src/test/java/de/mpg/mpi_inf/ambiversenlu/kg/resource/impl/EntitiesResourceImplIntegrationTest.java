 ...
 */
public class EntitiesResourceImplIntegrationTest extends JerseyTest {
  ...
  @Test public void testPostEntities() throws Exception {
    ...
    entities.add(ID_PREFIX+"Q44298");
    entities.add(ID_PREFIX+"Q183");
  ...
  public void testGetEntitiesByIds() throws Exception {
    ...
    idsSet.add(URLEncoder.encode(ID_PREFIX+"Q44298", "UTF-8"));
    idsSet.add(URLEncoder.encode(ID_PREFIX+"Q183", "UTF-8"));
